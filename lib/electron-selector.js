...
const ALLOWED_ELECTRON = {
    '42.5.1': {
        download: {
            'linux-x64':    'https://github.com/electron/electron/releases/download/v42.5.1/electron-v42.5.1-linux-x64.zip',
            'win32-x64':    'https://github.com/electron/electron/releases/download/v42.5.1/electron-v42.5.1-win32-x64.zip',
            'darwin-x64':   'https://github.com/electron/electron/releases/download/v42.5.1/electron-v42.5.1-darwin-x64.zip',
            'darwin-arm64': 'https://github.com/electron/electron/releases/download/v42.5.1/electron-v42.5.1-darwin-arm64.zip'
        }
    }
};
...
if (require.main === module) {
    ...
    if (result.needDownload) {
        console.log(JSON.stringify({ needDownload: true, version: result.version, url: result.url }));
        process.exit(2);
    }
